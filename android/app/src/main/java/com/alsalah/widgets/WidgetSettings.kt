...
internal const val PREF_USE_DARK_WIDGET_THEME = "use_dark_widget_theme"
...
internal const val DEFAULT_USE_DARK_WIDGET_THEME = false
...
internal fun getUseDarkWidgetTheme(context: Context): Boolean =
    context
        .getSharedPreferences(WIDGET_SETTINGS_PREFS, Context.MODE_PRIVATE)
        .getBoolean(
            PREF_USE_DARK_WIDGET_THEME,
            DEFAULT_USE_DARK_WIDGET_THEME,
        )
...
internal fun setUseDarkWidgetTheme(context: Context, enabled: Boolean) {
    context
        .getSharedPreferences(WIDGET_SETTINGS_PREFS, Context.MODE_PRIVATE)
        .edit()
        .putBoolean(PREF_USE_DARK_WIDGET_THEME, enabled)
        .apply()
}
